...
$average = $averagePerformance/$member_count;
    ...
    return view('admin.reports.index', compact('total_loan_req','average', 'member_count', 'recordWithHighestPledge','total_contribution', 'table','total_loaned_memb','average_loan_perf','total_loan_paid_less_100', 'total_loan_paid_100'));
}
