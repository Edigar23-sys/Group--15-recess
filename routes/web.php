...
Route::prefix('/admin')->group(function () {
    ...
    //Route::get('/reports', [EmailReportController::class, 'sendemail'])->name('admin.reports');
    ...
    Route::get('/email-reports/email', [EmailReportController::class, 'email'])->name('admin.email-reports.email');
